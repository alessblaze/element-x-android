...
object LightColorTokens {
    ...
    val colorAlphaGreen100  = Color(0x081a0057) // very dark violet, low alpha [web:68]
    val colorAlphaGreen200  = Color(0x0f1c005a) // deep violet, low alpha [web:68]
    val colorAlphaGreen300  = Color(0x1c22006a) // dark violet, medium-low alpha [web:68]
    val colorAlphaGreen400  = Color(0x3b2c0080) // dark saturated violet, medium alpha [web:68]
    val colorAlphaGreen500  = Color(0x693d009e) // mid violet, medium-high alpha [web:68]
    val colorAlphaGreen600  = Color(0x8f4a0db1) // brighter violet, high alpha [web:68]
    val colorAlphaGreen700  = Color(0xf55a27c6) // strong violet overlay [web:68]
    val colorAlphaGreen800  = Color(0xff7849ec) // bright violet, opaque [web:68]
    val colorAlphaGreen900  = Color(0xff9171f9) // accent violet, opaque [web:68]
    val colorAlphaGreen1000 = Color(0xff9e87fc) // lighter accent overlay [web:68]
    val colorAlphaGreen1100 = Color(0xffad9cfe) // high accent overlay [web:68]
    val colorAlphaGreen1200 = Color(0xffc4baff) // very light overlay [web:68]
    val colorAlphaGreen1300 = Color(0xffdedaff) // near-bg highlight [web:68]
    val colorAlphaGreen1400 = Color(0xffeeebff) // lightest HC wash [web:68]
    val colorAlphaLime100  = Color(0x0a17003a) // very dark cool‑violet, low alpha [web:68]
    val colorAlphaLime200  = Color(0x121b0042) // deep cool‑violet, low alpha [web:68]
    val colorAlphaLime300  = Color(0x2621004f) // dark cool‑violet, medium-low alpha [web:68]
    val colorAlphaLime400  = Color(0x4728005c) // cool‑violet, medium alpha [web:68]
    val colorAlphaLime500  = Color(0x82320070) // mid cool‑violet, medium-high alpha [web:68]
    val colorAlphaLime600  = Color(0xb53f0086) // brighter cool‑violet, high alpha [web:68]
    val colorAlphaLime700  = Color(0xdb4d00a0) // strong cool‑violet overlay [web:68]
    val colorAlphaLime800  = Color(0xe86b33e6) // bright cool‑violet, very high alpha [web:68]
    val colorAlphaLime900  = Color(0xf58a57f2) // high cool‑violet accent, very high alpha [web:68]
    val colorAlphaLime1000 = Color(0xffa27af6) // opaque light accent [web:68]
    val colorAlphaLime1100 = Color(0xffb391fb) // opaque lighter/selected [web:68]
    val colorAlphaLime1200 = Color(0xffcfc0ff) // very light decorative [web:68]
    val colorAlphaLime1300 = Color(0xffe3ddff) // near‑bg decorative [web:68]
    val colorAlphaLime1400 = Color(0xfff0edff) // lightest HC wash [web:68]
    ...
    val colorGreen100  = Color(0xfff6f5ff)
    val colorGreen200  = Color(0xffeeebff)
    val colorGreen300  = Color(0xffdedaff)
    val colorGreen400  = Color(0xffc4baff)
    val colorGreen500  = Color(0xff9e87fc)
    val colorGreen600  = Color(0xff8b66f8)
    val colorGreen700  = Color(0xff7343e6)
    val colorGreen800  = Color(0xff5a27c6)
    val colorGreen900  = Color(0xff4a0db1)
    val colorGreen1000 = Color(0xff3d009e)
    val colorGreen1100 = Color(0xff2c0080)
    val colorGreen1200 = Color(0xff22006a)
    val colorGreen1300 = Color(0xff1c005a)
    val colorGreen1400 = Color(0xff1a0055)
    val colorLime100  = Color(0xfff0edff)
    val colorLime200  = Color(0xffe3ddff)
    val colorLime300  = Color(0xffcfc0ff)
    val colorLime400  = Color(0xffb391fb)
    val colorLime500  = Color(0xffa27af6)
    val colorLime600  = Color(0xff8a57f2)
    val colorLime700  = Color(0xff6b33e6)
    val colorLime800  = Color(0xff4d00a0)
    val colorLime900  = Color(0xff3f0086)
    val colorLime1000 = Color(0xff320070)
    val colorLime1100 = Color(0xff28005c)
    val colorLime1200 = Color(0xff21004f)
    val colorLime1300 = Color(0xff1b0042)
    val colorLime1400 = Color(0xff17003a)
